...
@Injectable()
export class ShowcaseExpiredComponent implements OnInit, OnDestroy {
      ...
      querySnapshot.forEach(function (snapshot) {
        ...
        groupRef
          ...
          .then(function ( snapshot1 ) {
            ...
            if ((disabled || checked[cat - 1]) && state === 'expired') {
              ...
              self.containerViewService.setNumbOfDonationExpired(self.insertions.length);
            }
